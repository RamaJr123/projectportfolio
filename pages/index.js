  ...
  return (
    <div className={darkMode ? 'dark' : ''}>
      <Head>
        ...
        <meta name="description" content="Iqbal's private portfolio" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <main className=" bg-white px-10 dark:bg-gray-900 md:px-20 lg:px-40">
        <section className="min-h-screen">
          <nav className="py-10 mb-12 flex justify-between dark:text-white">
            <h1 className="font-burtons text-xl">iqbalr.</h1>
          ...
          <div className="text-center p-10 py-10">
            <h2 className="text-5xl py-2 text-teal-600 font-medium dark:text-teal-400 md:text-6xl">Iqbal Rizqi R.</h2>
            <h3 className="text-2xl py-2 dark:text-white md:text-3xl">Developer and editor.</h3>
            <p className="text-md py-5 leading-8 text-gray-800 dark:text-gray-200 max-w-xl mx-auto md:text-xl">
              A students from SMP Negeri 2 Mojokerto and a freelancer that providing a services for website developing and the other service. Join me!
            </p>
        ...
        <section>
          <div>
            ...
            <p className="text-md py-2 leading-8 text-gray-800 dark:text-gray-200">
              Since the beginning of my journey as a freelance website developer, I have done some remote work for
              <span className="text-teal-500"> agencies </span>
              and collaborated with my brother to create digital products for both business and consumer use.
            </p>
            <p className="text-md py-2 leading-8 text-gray-800 dark:text-gray-200">I offer from a wide range of services, including brand design, programming and editing.</p>
          </div>
          <div className="lg:flex gap-10">
            <div className="text-center shadow-lg p-10 rounded-xl my-10  dark:bg-white flex-1">
              <Image src={design} width={100} height={100} />
              <h3 className="text-lg font-medium pt-8 pb-2  ">Elegant Designs</h3>
              <p className="py-2">Creating elegant designs for many thing suited for your needs following core design theory.</p>
            ...
            <div className="text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white flex-1">
              ...
              <h4 className="py-4 text-teal-600">Programming Language and framework that I Use</h4>
            ...
            <div className="text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white flex-1">
              ...
              <h4 className="py-4 text-teal-600">We are accept an consulting of.</h4>
              <p className="text-gray-800 py-1">Website Project</p>
              <p className="text-gray-800 py-1">Website Design</p>
              <p className="text-gray-800 py-1">Video Editing</p>
